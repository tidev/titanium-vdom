...
export function registerCommonTitaniumElements(registry: TitaniumElementRegistry) {
    ...
    registry.registerElement('DetachedView', () => Ti.UI.createView, { detached: true, typeName: 'Ti.UI.View' });
    ...
    registry.registerElement('Toolbar', () => Ti.UI.createToolbar, { typeName: 'Ti.UI.Toolbar' });
